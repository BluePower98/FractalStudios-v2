...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Arquitectura e ingeneria</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.php">Inicio</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Cursos</span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Arquitectura e ingeneria</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="section-title text-center mb-65">
                     ...
                     <h2 class="tp-section-title mb-20">Arquitectura e ingeneria</h2>
                  </div>
               </div>
            </div>
            <div class="row mb-20">
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="metodos-costos-produccion-programacion"><img src="assets/img/course/arquitectura-e-ingeneria-1.jpg" alt="course-thumb"></a>
                        <div class="tpcourse__tag">
                           <a href="metodos-costos-produccion-programacion"><i class="fi fi-rr-heart"></i></a>
                        </div>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="metodos-costos-produccion-programacion">Metodos + Costos + Producción + Programación</a></h4>
                           <br>
                        </div>
                        <div class="tpcourse__category mb-10">
                           <ul class="tpcourse__price-list d-flex align-items-center">
                              <li><a class="c-color-yellow" href="metodos-costos-produccion-programacion">Mas detalles</a></li>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="expediente-tecnico-valorización-liquidación-de-obras"><img src="assets/img/course/arquitectura-e-ingeneria-2.jpg" alt="course-thumb"></a>
                        <div class="tpcourse__tag">
                           <a href="expediente-tecnico-valorización-liquidación-de-obras"><i class="fi fi-rr-heart"></i></a>
                        </div>
                        <div class="tpcourse__img-icon">
                           <img src="assets/img/icon/fracta-icon.png" alt="course-avata">
                        </div>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="expediente-tecnico-valorización-liquidación-de-obras">Expediente Técnico + Valorización y Liquidación de Obras</a></h4>
                           <br>
                        </div>
                        <div class="tpcourse__category mb-10">
                           <ul class="tpcourse__price-list d-flex align-items-center">
                           <li><a class="c-color-yellow" href="expediente-tecnico-valorización-liquidación-de-obras">Mas detalles</a></li>
                           <li><a class="c-color-green" href="https://api.whatsapp.com/send?phone=974856590&text=Hola, Nececito mas informacion sobre el curso Expediente Técnico + Valorización y Liquidación de Obras" target="_blank"><i class="fa-brands fa-whatsapp"></i> Enviar Mensaje</a></li>
      ...
      <!-- suitable-area -->
      <!-- <section class="suitable-area bg-bottom grey-bg pt-115 pb-90" data-background="assets/img/bg/shape-bg-1.png">
         <div class="container">
