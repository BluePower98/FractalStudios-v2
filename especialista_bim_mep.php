...
<body>
   ...
   <main>
      ...
      <!-- breadcrumb-area -->
      <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="assets/img/breadcrumb/especialistas-metodologia-bim.jpg">
         <div class="container">
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Especialista Bim Mep</h3>
                     <div class="breadcrumb__list">
                        ...
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Especialista Bim Mep</span>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="postbox__thumb postbox__slider w-img mb-30 p-relative">
                     ...
                     <div class="course-details-content mb-45">
                        ...
                        <div class="tpcourse__ava-title mb-25">
                           <h4 class="c-details-title"><a href="#">Especialista Bim Mep</a></h4>
                        </div>
                     ...
                     <div class="c-details-about mb-40">
                        ...
                        <p align="justify">Los participantes del curso adquiriran los conocimientos necesarios para utilizar el software. Dominar las pautas de las buenas practicas de modelado utilizando ejercisios efectivos de manera colaborativa, automatizada y productiva. Hacer un uso optimo y eficaz de herramientas, criterios y metodologias para producir dicha informacion de acuerdo con la normativa BIM, las guias nacionales vigentes y la ISO 19650</p>
                     </div>
                     <div class="cor-details-instructor mb-40">
                        ...
                        <div class="course-instructor-details d-flex f-wrap align-items-center">
                           ...
                           <div class="course-avatar-details mb-20">
                              ...
                              <p>Bim Manager Argentina Expert Elite</p>
                     ...
                     <div class="course-details-widget">
                        <div class="cd-video-price">
                           ...
                           <div class="cd-pricing-btn text-center mb-30">
                              <a class="tp-vp-btn" href="assets/pdf/brochure02.pdf" target="_blank"><i class="fa-solid fa-file-pdf"></i> Brochure</a>
                              <a class="tp-vp-btn-green" href="https://api.whatsapp.com/send?phone=984749614&text=Hola, Nececito mas informacion sobre el curso Especialista Bim Mep" target="_blank"><i class="fa-brands fa-whatsapp"></i> Enviar Mensaje</a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="especialista-modelador-bim"><img src="assets/img/course/1.jpg" alt="course-thumb"></a>
                        <div class="tpcourse__tag">
                           <a href="especialista-modelador-bim"><i class="fi fi-rr-heart"></i></a>
                        </div>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="especialista-modelador-bim">Especialista Modelador Bim</a></h4>
                        </div>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="especialista-coordinador-bim"><img src="assets/img/course/3.jpg" alt="course-thumb"></a>
                        <div class="tpcourse__tag">
                           <a href="especialista-coordinador-bim"><i class="fi fi-rr-heart"></i></a>
                        </div>
                        <div class="tpcourse__img-icon">
                           <img src="assets/img/icon/fracta-icon.png" alt="course-avata">
                        </div>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="especialista-coordinador-bim">Especialista Coordinador Bim</a></h4>
                        </div>
                        <div class="tpcourse__category mb-10">
                           <ul class="tpcourse__price-list d-flex align-items-center">
