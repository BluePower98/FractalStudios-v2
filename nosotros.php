...
<body>
   ...
   <main>
      ...
      <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="assets/img/breadcrumb/slider-nosotros.jpg">
         <div class="container">
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Sobre Nosotros</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.php">Inicio</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Sobre Nosotros</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <section class="feature-area pt-120 pb-90">
         <div class="container">
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-6">
                     <div class="tpfea tp-feature-item text-center mb-30">
                        ...
                        <div class="tpfea__text">
                           <h5 class="tpfea__title mb-5">Cursos online</h5>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-6 col-md-6">
            ...
            <div class="row text-center">
               <div class="col-lg-12">
                  <div class="section-title mb-60">
                     <span class="tp-sub-title-box mb-15">Misión y Visión</span>
                  </div>
               </div>
            </div>
            <div class="row">
                  ...
                  <div class="accordion pb-20" id="accordionExample">
                     <div class="accordion-items">
                       ...
                       <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                         ...
                         Trabajar permanentemente en la capacitación técnica y académica de estudiantes que buscan destacar y fortalecer sus conocimientos a fin de destacar como profesionales. 
                         </div>
                       </div>
                     </div>
                     <div class="accordion-items">
                       ...
                       <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                         <div class="accordion-body">
                         Ser una empresa reconocida y líder en el rubro educativo que brinda un servicio de calidad y busca formar profesionales mejor capacitados y especializados en las diversas áreas de la arquitectura e ingeniería. 
                         </div>
                       </div>
                     </div>
            ...
            <div class="row text-center">
               <div class="col-lg-12 col-md-12">
                  <div class="section-title mb-65">
                     ...
                     <h2 class="tp-section-title mb-20">Video de calidad HD <br> audio
y clases en vivo</h2>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12">
                  <div class="video-bg p-relative text-center">
                     ...
                     <div class="video-shape-area">
                        ...
                        <img class="video-shape-2 d-none d-md-block" src="assets/img/about/video-2-shape-2.png" alt="video-shape">
                        <img class="video-shape-3 d-none d-md-block" src="assets/img/about/video-2-shape-1.jpg" alt="video-shape">
                     </div>
                  </div>
               </div>
            </div>
      ...
      <!-- <section class="choose-area bg-bottom pb-120">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-xl-5 col-lg-6 col-md-12">
                  <div class="tp-choose-content mb-30">
                     <div class="section-title mb-25">
                        <span class="tp-sub-title-box mb-15">Why Choose Us</span>
                     ...
                     <div class="tp-choose-list tp-choose-bg mb-60">
                        <ul>
                           <li>
                              <div class="tp-list-bg choose-sub-color">
                                 <i class="fa-light fa-check"></i>Increasing Your Learning Skills
                              </div>
                           </li>
                           <li>
                              <div class="tp-list-bg choose-sub-color">
                                 <i class="fa-light fa-check"></i>High Quality Video & Audio Classes
                              </div>
                           </li>
                           <li>
                              <div class="tp-list-bg choose-sub-color">
                                 <i class="fa-light fa-check"></i>Finish Your Course, Get Certificate
                              </div>
                           </li>
                        </ul>
                     </div>
                     <div class="choose-btn">
                        <a href="#" class="tp-btn">More Details</a>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="tp-choose-img tp-choose-img-2 p-relative mb-30 mr-50 text-end">
                     ...
                     <div class="tpchoose-img-text tp-chose-shape d-none d-md-block">
                        <ul>
                           ...
                           <li>
                              <p>Fully Safe & Secure</p>
                              <img src="assets/img/icon/choose-2-shape.png" alt="choose-shape">
                           </li>
                        </ul>
                     </div>
                  </div>
      ...
      <section class="testimonial-area bg-bottom pt-120 pb-90 " data-background="assets/img/bg/shape-bg-1.png">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
            ...
            <div class="testimonial-active-box tp-slide-space-white">
                  ...
                  <div class="tp-testi tp-testi-round p-relative">
                     <div class="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                        ...
                        <div class="tp-testi__avainfo ml-20">
                           <h3 class="tp-testi__title tp-title-meta mt-5">Darrell Steward</h3>
               ...
               <div class="tp-test-s-item">
                  <div class="tp-testi p-relative">
                     <div class="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                        <img src="assets/img/icon/testi-ava-sub-1.png" alt="testi-avatar">
                        <div class="tp-testi__avainfo ml-20">
                           <h3 class="tp-testi__title tp-title-meta mt-5">Ralph Edwards</h3>
               ...
               <div class="tp-test-s-item">
                  <div class="tp-testi p-relative">
                     <div class="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                        <img src="assets/img/icon/testi-ava-sub-2.png" alt="testi-avatar">
                        <div class="tp-testi__avainfo ml-20">
