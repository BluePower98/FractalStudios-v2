...
<body>
   ...
   <main>
      ...
      <!-- breadcrumb-area -->
      <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="assets/img/breadcrumb/modelado-3d-visualizacion-arquitectonica.jpg">
         <div class="container">
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Post-Producción de Plantas Arquitectonica</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index">Inicio</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span><a href="courses">Cursos</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span><a href="modelado-3d-visualizacion-arquitectonica">Modelado 3D y visualización Arquitectónica</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Post-Producción de Plantas Arquitectonica</span>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="c-details-wrapper mr-25">
                     ...
                     <div class="course-details-content mb-45">
                        ...
                        <div class="tpcourse__ava-title mb-25">
                           <h4 class="c-details-title"><a href="#">Post-Producción de Plantas Arquitectonica</a></h4>
                        </div>
                     ...
                     <div class="cor-details-instructor mb-40">
                        ...
                        <div class="course-instructor-details d-flex f-wrap align-items-center">
                           <div class="course-avata mr-30 mb-20">
                              <img src="assets/img/course/perfil.jpg" alt="avata-thumb">
                           </div>
                           <div class="course-avatar-details mb-20">
                              <h5 class="c-avata-title mb-10">Deborah Diaz Moscoso</h5>
                              <p>Arquitecta</p>
                     ...
                     <div class="course-details-widget">
                        <div class="cd-video-price">
                           ...
                           <div class="cd-pricing-btn text-center mb-30">
                              <a class="tp-vp-btn" href="assets/pdf/brochure09.pdf" target="_blank"><i class="fa-solid fa-file-pdf"></i> Brochure</a>
                              <a class="tp-vp-btn-green" href="https://api.whatsapp.com/send?phone=985153508&text=Hola, Nececito mas informacion sobre el curso Post-Producción de Plantas Arquitectonica" target="_blank"><i class="fa-brands fa-whatsapp"></i> Enviar Mensaje</a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="sketchup-vray-photoshop"><img src="assets/img/course/photoshop.jpg" alt="course-thumb"></a>
                        <div class="tpcourse__tag">
                           <a href="sketchup-vray-photoshop"><i class="fi fi-rr-heart"></i></a>
                        </div>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="sketchup-vray-photoshopcourse-details.html">Sketchup + vray + Photoshop</a></h4>
                           <br>
                        </div>
