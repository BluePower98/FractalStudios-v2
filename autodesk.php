...
<body>
   ...
   <main>
      ...
      <!-- breadcrumb-area -->
      <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="assets/img/breadcrumb/autodesk.jpg">
         <div class="container">
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Autodesk</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.php">Inicio</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Cursos</span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Autodesk</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="section-title text-center mb-65">
                     ...
                     <h2 class="tp-section-title mb-20">Autodesk</h2>
                  </div>
               </div>
            </div>
            <div class="row mb-20">
