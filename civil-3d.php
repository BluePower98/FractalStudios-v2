            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Civil 3D</h3>
                     <div class="breadcrumb__list">
                        ...
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Civil 3D</span>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="postbox__thumb postbox__slider w-img mb-30 p-relative">
                     ...
                     <div class="course-details-content mb-45">
                        ...
                        <div class="tpcourse__ava-title mb-25">
                           <h4 class="c-details-title"><a href="#">Civil 3D</a></h4>
                        </div>
                     ...
                     <div class="cor-details-instructor mb-40">
                        ...
                        <div class="course-instructor-details d-flex f-wrap align-items-center">
                           ...
                           <div class="course-avatar-details mb-20">
                              <h5 class="c-avata-title mb-10">Swiv Aldo Pairazaman Amaya</h5>
                              <p>Instructor Especializado</p>
                     ...
                     <div class="course-details-widget">
                        <div class="cd-video-price">
                           ...
                           <div class="cd-pricing-btn text-center mb-30">
                              <a class="tp-vp-btn" href="assets/pdf/brochure05.pdf" target="_blank"><i class="fa-solid fa-file-pdf"></i> Brochure</a>
                              <a class="tp-vp-btn-green" href="https://api.whatsapp.com/send?phone=984749614&text=Hola, Nececito mas informacion sobre el curso Civil 3D" target="_blank"><i class="fa-brands fa-whatsapp"></i> Enviar Mensaje</a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="autocard-2d-3d"><img src="assets/img/course/autodesk-1.jpg" alt="course-thumb"></a>
                        <div class="tpcourse__tag">
                           <a href="autocard-2d-3d"><i class="fi fi-rr-heart"></i></a>
                        </div>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="autocard-2d-3d">Autocard 2D + 3D</a></h4>
                        </div>
                        <div class="tpcourse__category mb-10">
                           <ul class="tpcourse__price-list d-flex align-items-center">
                              <li><a class="c-color-yellow" href="autocard-2d-3d">Mas detalles</a></li>
