            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Metodos + Costos + Producción + Programación</h3>
                     <div class="breadcrumb__list">
                        ...
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Metodos + Costos + Producción + Programación</span>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="c-details-wrapper mr-25">
                     ...
                     <div class="course-details-content mb-45">
                        ...
                        <div class="tpcourse__ava-title mb-25">
                           <h4 class="c-details-title"><a href="#">Metodos + Costos + Producción + Programación</a></h4>
                        </div>
                     ...
                     <div class="course-details-widget">
                        <div class="cd-video-price">
                           ...
                           <div class="cd-pricing-btn text-center mb-30">
                              <a class="tp-vp-btn" href="assets/pdf/brochure10.pdf" target="_blank"><i class="fa-solid fa-file-pdf"></i> Brochure</a>
                              <a class="tp-vp-btn-green" href="https://api.whatsapp.com/send?phone=974856590&text=Hola, Nececito mas informacion sobre el curso Metodos + Costos + Producción + Programación" target="_blank"><i class="fa-brands fa-whatsapp"></i> Enviar Mensaje</a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tpcourse mb-40">
                     <div class="tpcourse__thumb p-relative w-img fix">
                        <a href="course-details.html"><img src="assets/img/course/arquitectura-e-ingeneria-2.jpg" alt="course-thumb"></a>
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="course-details.html">Expediente Técnico + Valorización y Liquidación de Obras</a></h4>
                           <br>
                        </div>
                        <div class="tpcourse__category mb-10">
                           <ul class="tpcourse__price-list d-flex align-items-center">
                           <li><a class="c-color-yellow" href="course-details.html">Mas detalles</a></li>
