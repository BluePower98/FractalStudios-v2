            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Diseño-interiores</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index">Inicio</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span><a href="courses">Cursos</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Diseño-interiores</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="section-title text-center mb-65">
                     ...
                     <h2 class="tp-section-title mb-20">Diseño-interiores</h2>
                  </div>
               </div>
            </div>
            <div class="row mb-20">
