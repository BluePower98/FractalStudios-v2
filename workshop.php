...
<body>
   ...
   <main>
      ...
      <!-- breadcrumb-area -->
      <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="assets/img/breadcrumb/diseño-interiores.jpg">
         <div class="container">
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Workshop</h3>
                     <div class="breadcrumb__list">
                        ...
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Workshop</span>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="postbox__thumb postbox__slider w-img mb-30 p-relative">
                     ...
                     <div class="course-details-content mb-45">
                        ...
                        <div class="tpcourse__ava-title mb-25">
                           <h4 class="c-details-title"><a href="#">Workshop</a></h4>
                        </div>
                     ...
                     <div class="cor-details-instructor mb-40">
                        ...
                        <div class="course-instructor-details d-flex f-wrap align-items-center">
                           ...
                           <h5 class="c-avata-title mb-10">Natalia Aguirre Coronado</h5>
                              <p>Arquitecta</p>
                     ...
                     <div class="course-details-widget">
                        <div class="cd-video-price">
                           ...
                           <div class="cd-pricing-btn text-center mb-30">
                              <a class="tp-vp-btn" href="#" target="_blank"><i class="fa-solid fa-file-pdf"></i> Brochure</a>
                              <a class="tp-vp-btn-green" href="https://api.whatsapp.com/send?phone=985153508&text=Hola, Nececito mas informacion sobre el curso Workshop" target="_blank"><i class="fa-brands fa-whatsapp"></i> Enviar Mensaje</a>
                  ...
                  <div class="tpcourse mb-40">
                     ...
                     <div class="tpcourse__content-2">
                        ...
                        <div class="tpcourse__ava-title mb-15">
                           <h4 class="tpcourse__title tp-cours-title-color"><a href="diseno-de-interiores">Diseño de Interiores</a></h4>
                        </div>
